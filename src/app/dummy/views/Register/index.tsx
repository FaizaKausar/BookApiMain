    ...
    <div className="w-full max-w-xs mx-auto  justify-center items-center h-screen">
      ...
      >
        ...
        <div className="mb-6">
          ...
          <input
            className="  mb-3 focus:shadow-outline"
            name="clientEmail"
            type="email"
        ...
        <div className="flex items-center justify-center">
          <button
            className="bg-blue-300 hover:bg-blue-300 text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="submit"
          >
            Submit
          </button>
